...
public class Test {
	...
	public static void closeAllDoors(DomoticaObject object) {
		SetAllDoorsClosed close = new SetAllDoorsClosed(object);
		close.execute();
		object.update();
	}

	public static void openAllDoors(DomoticaObject object) {
		SetAllDoorsOpen open = new SetAllDoorsOpen(object);
		open.execute();
		object.update();
	}
